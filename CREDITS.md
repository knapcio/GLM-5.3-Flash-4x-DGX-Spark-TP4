...
- **tonyd2wild** — the ARM64 vLLM image `ghcr.io/tonyd2wild/vllm-glm53-flash:sm121-v11-dflash2` (vLLM `487ecf187` with the SM121 DFlash2 and NoPE sparse-attention patches), `overlay/sparse_attn_indexer_kpool.py`, the GB10 Triton MoE config and the boot-time cache flusher. Recipes: [GLM-5.3-Flash-NVFP4-DFlash2-2x-DGX-Spark](https://github.com/tonyd2wild/GLM-5.3-Flash-NVFP4-DFlash2-2x-DGX-Spark), [GLM-5.3-Flash-NVFP4-1M-KV-4x-DGX-Spark](https://github.com/tonyd2wild/GLM-5.3-Flash-NVFP4-1M-KV-4x-DGX-Spark).
